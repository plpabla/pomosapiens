...
- [ ] 1.3 Integration tests pass: `npm test -- tests/integration/api/sessions.end.test.ts`
- [ ] 1.4 pgTAP RLS tests pass: `npm run db:test`
- [ ] 1.5 Full test suite passes: `npm test`
