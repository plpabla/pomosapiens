...
- [x] 5.1 New spec passes: `npm run test:e2e -- anonymous-capture` -- 100ebc0
- [x] 5.2 Full suite passes: `npm run test:e2e` -- 100ebc0
- [x] 5.3 Lint passes: `npm run lint` -- 100ebc0
