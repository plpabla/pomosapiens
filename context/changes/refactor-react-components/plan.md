...
- [ ] 3.4 Affected e2e pass (capture/edit)
...
- [ ] 8.1 Extended tests pass pre- and post-refactor: `npm test`
- [ ] 8.2 Lint passes: `npm run lint`
- [ ] 8.3 Build passes: `npm run build`
- [ ] 8.4 Affected e2e pass; full suite green before PR
