...
describe("FocusRatingChart", () => {
  ...
  it("shows an empty-state message when there is only one rated session", () => {
    render(<FocusRatingChart sessions={[{ started_at: "2026-07-01T10:00:00Z", focus_rating: 4 }]} />);
  ...
  it("renders the chart instead of the empty state when there are 2+ rated sessions", () => {
    render(
      <FocusRatingChart
        sessions={[
          { started_at: "2026-07-01T10:00:00Z", focus_rating: 4 },
          { started_at: "2026-07-02T10:00:00Z", focus_rating: 5 },
        ]}
      />,
    );
